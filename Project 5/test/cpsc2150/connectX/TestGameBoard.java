...
public class TestGameBoard {
    ...
    private IGameBoard CreateGameBoard(){
        ...
        IGameBoard testBoard = new GameBoard(5,5,3);
        return testBoard;
    }


    private IGameBoard CreateGameBoard_different_size(int row, int col, int numToWin){
        IGameBoard testBoard = new GameBoard(row,col, numToWin);
        return testBoard;
    }
    ...
    @Test
    public void checkVertWin_from_top(){
    ...
    // with spots below
    @Test
    public void checkVertWin_false_with_empty_spot_above(){
    ...
    @Test
    public void WhatsAtPos_spot_surrounded_by_chars(){
        IGameBoard board = CreateGameBoard();
        board.placeToken('O', 0);
        board.placeToken('X', 0);
        board.placeToken('O', 0);
